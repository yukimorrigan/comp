...
<div class="container content-container default-container">	
	<h3 class="h3 text-center mx-auto text-clr">Редактирование данных</h3>

	<?php if ($result): ?>
		<p class="green">Данные отредактированы!</p>
	<?php else: ?>
	...
	<form action="#" method="post">
		...
		<div class="form-group row">
		    <div class="col-sm-10 text-right">
		      <input type="submit" name="submit" class="btn btn-primary" value="Сохранить"></input>
		    </div>
		</div>
	</form>
